...
const App = () => {
  ...
  useEffect(() => {
    fetchMovies()
  }, []) // What is useEffect? It runs side effects. Side effects are operations that affect something outside the component, like fetching data, setting up subscriptions, or manually changing the DOM.
